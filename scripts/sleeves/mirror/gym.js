export async function main(ns) {
    ...
    if (!mainPlayerWork || mainPlayerWork.type !== typeOfWork || mainPlayerWork.location !== "Powerhouse Gym") {
        return;
    }
    ...
    for (let sleeve of sleevesData.sleeves) {
        ...
        if (!sleeve.task ||
            ...
            ns.sleeve.setToGymWorkout(sleeve.name, mainPlayerWork.location, mainPlayerWork.classType);
        }
